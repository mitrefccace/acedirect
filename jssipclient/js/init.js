...
$(document).ready(function(){
  ...
  var tryit_ws_uri = "wss://tryit.jssip.net:10443";
  var invitation_link_pre = "https://tryit.jssip.net?invited-by="


  // Initialization.
  //login_ws_servers.val(tryit_ws_uri);  NJ - commented out for HTTPS (using config. values)
  ...
  function phoneInit() {
    ...
    ua.on('unregistered', function(e){
      ...
      GUI.setStatus("connected");
	  ua.stop(); //NJ - Fixed the Asterisk websocket disconnect error  10.14.2016
    });
